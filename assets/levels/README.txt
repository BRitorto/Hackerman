The level.txt files are read as follows:
  The keywords GUARDS, CAMERAGUARDS, COMPUTERS, DOOR, HACKER and MAP divide the text into data chunks. What is left between keywords 
  is data of an element of the collection that the keyword in the right represents. For all keywords but the MAP, this data is Integers
  and they represent the following values (by order of appearance):
